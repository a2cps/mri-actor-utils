...
#   filename:  https://github.com/tapis-project/tapipy/raw/main/tapipy/resources/openapi_v3-jobs.yml
#   timestamp: 2024-09-02T15:21:42+00:00
...
class JobListDTO(BaseModel):
    ...
    remoteStarted: datetime | None = None
